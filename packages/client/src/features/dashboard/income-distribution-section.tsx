...
export function IncomeDistributionSection() {
  return (
    <div className="col-span-full lg:px-8 pb-8 h-fit lg:h-[40%] lg:mb-8">
      <main className="h-full flex-col grid lg:max-w-none grid-cols-12  lg:px-0 gap-8">
        <div className="col-span-7 h-full">
          ...
          <div className="w-full h-full bg-card rounded-lg lg:block hidden"></div>
        </div>
        <div className="col-span-12 lg:col-span-5 h-full flex flex-col">
          ...
          <div className="flex lg:grid lg:grid-cols-2 grid-overflow-x overflow-x-scroll lg:overflow-x-hidden gap-4">
            {[1, 2, 3, 4].map(() => (
